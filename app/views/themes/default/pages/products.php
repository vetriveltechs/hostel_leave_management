...
<body data-mobile-nav-style="classic" class="custom-cursor">
    ...
    ?>
         <section class="mt-5 ipad-top-space-margin bg-dark-gray cover-background page-title-big-typography" style="background-image: url(<?php echo base_url(); ?>assets/frontend/img/product-banner.png)">
    ...
    <section class="bg-tranquil position-relative " style="    background-color: #f3f8f8;">
        <div class="position-absolute left-minus-200px top-25" data-bottom-top="transform: translateY(-80px)" data-top-bottom="transform: translateY(80px)">
            <img src="<?php echo base_url(); ?>assets/frontend/img/demo-elearning-bg-02.png" alt="">
        </div>
        <div class="container">
                            ...
                            <div class="col-12 filter-content p-md-0">
                                <ul class="portfolio-wrapper grid-loading grid grid-3col xxl-grid-3col xl-grid-3col lg-grid-2col md-grid-2col sm-grid-1col xs-grid-1col gutter-extra-large">
                                    ...
                                    <?php 
                                        ...
                                        {
                                            $product_page_url   = ($products['product_url'] === 'hrms') ? "https://hrms.jesperapps.com/" : base_url() . 'product-details/' . strtolower($products['list_code']) . '/' . $products['product_url'];
    ...
    <section class="background-position-center-top p-0 sm-background-image-none pt-10 pb-5 --pb-10" style="background-image: url('https://www.aideanex.com/assets/frontend/img/vertical-line-bg.svg')">
            <div class="container">
            <div class="row align-items-center justify-content-center">
                    ...
                    <h3 class="alt-font text-dark fw-600 ls-minus-1px">Project We Delivered</h3>                    </div>
