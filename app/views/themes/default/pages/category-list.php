						...
						if(count($subCategories) > 0)
						{
							foreach($subCategories as $category)
							{
								...
								<div class="col-12 col-lg-6 col-md-6 col-sm-6 col-xl-3"> 
									<a href="<?php echo base_url();?>products-list.html/<?php echo $category['list_type_value_id'];?>" class="new-sub-category">
										<div class="category-boxholder">
											<div class="category-border">
												<div class="img-product">
													<?php 
														$url = "uploads/list_image/".$category['list_type_value_id'].".png";
														if(file_exists($url) && !empty($category['list_type_value_id']))
														{
															?>
															<img src="<?php echo base_url().$url;?>" alt="<?php echo ucfirst($category['list_type_value_id']);?>" data-src="<?php echo base_url().$url;?>" alt="<?php echo ucfirst($category['list_type_value_id']);?>" class="lazy img-fluid" >
															<?php 
															$category['list_type_value_id'];
														}
														else
														{ 
															?>
												...
												<div class="buttons">
													<a href="<?php echo base_url();?>products-list.html/<?php echo $category['list_type_value_id'];?>" title="<?php echo base_url();?>products-list.html/<?php echo $category['list_type_value_id'];?>" class="btn btn-default">
														<img src="<?php echo base_url();?>assets/frontend/img/home/right-arrow.png" class="arrow-left" alt="Arrow Left"> 
													</a>
													<a href="<?php echo base_url();?>products-list.html/<?php echo $category['list_type_value_id'];?>" class="btn btn-orange">
