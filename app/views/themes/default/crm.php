<body data-mobile-nav-trigger-alignment="right" data-mobile-nav-style="modern" data-mobile-nav-bg-color="#242E45">
        <div class="box-layout">
                    ...
                    <div id="demo-corporate-slider" class="rev_slider bg-regal-blue fullscreenbanner" style="display:none;" data-version="5.3.1.6">
                        ...
                        <ul>
                            ...
                            <li data-index="rs-01" data-transition="parallaxleft" data-slotamount="default"
                                ...
                                <img src="<?php echo base_url();?>assets/frontend/img/demo-corporate-main-slider-01.jpg" alt="Image"
                            ...
                            <li data-index="rs-02" data-transition="parallaxleft" data-slotamount="default"
                                ...
                                data-description="">
                                <!-- slide's main background image -->
                                <img src="<?php echo base_url();?>assets/frontend/img/demo-corporate-main-slider-02.jpg" alt="Image"
                                     data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat"
                                     class="rev-slidebg" data-no-retina>
                                <!-- start overlay layer -->
                            ...
                            <li data-index="rs-03" data-transition="parallaxleft" data-slotamount="default"
                                ...
                                data-description="">
                                <!-- slide's main background image -->
                                <img src="<?php echo base_url();?>assets/frontend/img/demo-corporate-main-slider-03.jpg" alt="Image"
                                     data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat"
                                     class="rev-slidebg" data-no-retina>
                                <!-- start overlay layer -->
                ...
                <div class="container">
                    <div class="row justify-content-center align-items-center mb-6 sm-pb-9">
                        <div class="col-lg-6 col-md-9 position-relative md-mb-15 text-center text-lg-start"
                            ...
                            <img src="<?php echo base_url();?>assets/frontend/img/demo-corporate-03.png" alt="">
                            <img src="<?php echo base_url();?>assets/frontend/img/demo-corporate-01.png" class="position-absolute top-50 left-minus-100px lg-left-minus-40px sm-left-minus-30px lg-w-50 sm-w-55" data-bottom-top="transform: translateY(50px)" data-top-bottom="transform: translateY(-220px)" alt="">
                            <img src="<?php echo base_url();?>assets/frontend/img/demo-corporate-02.png" class="position-absolute top-0px xl-top-minus-10px w-170px right-20px md-right-40px xs-w-40" data-bottom-top="transform: translateY(-50px)" data-top-bottom="transform: translateY(50px)" alt="">
                        </div>
            ...
            <section class="overflow-hidden bg-regal-blue position-relative border-radius-6px lg-border-radius-0px z-index-0">
                <img src="<?php echo base_url();?>assets/frontend/img/demo-corporate-bg-01.png" class="position-absolute top-minus-150px left-minus-30px z-index-minus-1" data-bottom-top="transform: rotate(0deg) translateY(0)" data-top-bottom="transform:rotate(-20deg) translateY(0)" alt="" />
                <div class="container">
                                    ...
                                    <div class="swiper-wrapper">
                                        ...
                                        <div class="swiper-slide">
                                            ...
                                            <div class="interactive-banner-style-09 border-radius-6px overflow-hidden position-relative">
                                                <img src="<?php echo base_url();?>assets/frontend/img/demo-corporate-slider-img-01.jpg" alt="" />
                                        ...
                                        <div class="swiper-slide">
                                            <!-- start interactive banner item -->
                                            <div class="interactive-banner-style-09 border-radius-6px overflow-hidden position-relative">
                                                <img src="<?php echo base_url();?>assets/frontend/img/demo-corporate-slider-img-02.jpg" alt="" />
                                        ...
                                        <div class="swiper-slide">
                                            <!-- start interactive banner item -->
                                            <div class="interactive-banner-style-09 border-radius-6px overflow-hidden position-relative">
                                                <img src="<?php echo base_url();?>assets/frontend/img/demo-corporate-slider-img-03.jpg" alt="" />
                                                <div class="opacity-very-light bg-slate-blue"></div>
                                                <div class="image-content h-100 w-100 ps-15 pe-15 pt-13 pb-13 md-p-10 d-flex justify-content-bottom align-items-start flex-column">
                                                    <div class="hover-label-icon position-relative z-index-9">
                                        ...
                                        <div class="swiper-slide">
                                            <!-- start interactive banner item -->
                                            <div class="interactive-banner-style-09 border-radius-6px overflow-hidden position-relative">
                                                <img src="<?php echo base_url();?>assets/frontend/img/demo-corporate-slider-img-04.jpg" alt="" />
                                                <div class="opacity-very-light bg-slate-blue"></div>
                                                <div class="image-content h-100 w-100 ps-15 pe-15 pt-13 pb-13 md-p-10 d-flex justify-content-bottom align-items-start flex-column">
                                                    <div class="hover-label-icon position-relative z-index-9">
                ...
                <div class="container position-relative">
                    <div class="row align-items-center mb-7">
                        ...
                        <div class="col-lg-7 offset-xxl-1 position-relative md-mb-30px sm-mb-15"
                            ...
                            <img src="<?php echo base_url();?>assets/frontend/img/demo-corporate-10.png" class="position-relative z-index-9 top-40px" alt="">
                            <img src="<?php echo base_url();?>assets/frontend/img/demo-corporate-03.png" class="absolute-middle-center xs-w-95" alt="">
                            <img src="<?php echo base_url();?>assets/frontend/img/demo-corporate-05.png" class="position-absolute top-50px left-0px xs-left-15px"
                                 data-bottom-top="transform: translateY(-50px)" data-top-bottom="transform: translateY(50px)"
                                 alt="">
                            <img src="<?php echo base_url();?>assets/frontend/img/demo-corporate-06.png" class="position-absolute top-150px left-30"
                                 data-bottom-top="transform: translateY(30px)" data-top-bottom="transform: translateY(-30px)"
                                 alt="">
                            <img src="<?php echo base_url();?>assets/frontend/img/demo-corporate-07.png" class="position-absolute top-50px right-30"
                                 data-bottom-top="transform: translateY(-50px)" data-top-bottom="transform: translateY(50px)"
                                 alt="">
                            <img src="<?php echo base_url();?>assets/frontend/img/demo-corporate-08.png"
            ...
            <section class="bg-gradient-quartz-white border-radius-6px lg-border-radius-0px">
                <div class="container background-no-repeat background-position-top"
                     style="background-image: url('<?php echo base_url();?>assets/frontend/img/demo-corporate-bg-02.png')">
                            ...
                            <div class="swiper magic-cursor testimonials-style-06" data-slider-options='{ "loop": true, "autoplay": { "delay": 4000, "disableOnInteraction": false }, "keyboard": { "enabled": true, "onlyInViewport": true }, "navigation": { "nextEl": ".swiper-button-next-nav", "prevEl": ".swiper-button-previous-nav", "effect": "fade" } }'>
                                <div class="swiper-wrapper">
                                    ...
                                    <div class="swiper-slide">
                                        <div class="row align-items-center justify-content-center">
                                            <div class="col-8 col-md-4 col-sm-6 text-center md-mb-30px">
                                                <img alt="" src="<?php echo base_url();?>assets/frontend/img/demo-corporate-testimonials-01.png">
                                            </div>
                                            <div class="col-lg-5 col-md-7 last-paragraph-no-margin text-center text-md-start">
                                                <a href="#" class="mb-15px d-block"><img src="<?php echo base_url();?>assets/frontend/img//logo-monday-dark-blue-01.svg" class="h-35px" alt=""></a>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="row align-items-center justify-content-center">
                                            <div class="col-8 col-md-4 col-sm-6 text-center md-mb-30px">
                                                <img alt="" src="<?php echo base_url();?>assets/frontend/img/demo-corporate-testimonials-02.png">
                                            </div>
                                            <div class="col-lg-5 col-md-7 last-paragraph-no-margin text-center text-md-start">
                                                <a href="#" class="mb-15px d-block"><img src="<?php echo base_url();?>assets/frontend/img/logo-loitech-dark-blue.svg" class="h-35px" alt=""></a>
                                                <span class="mb-5px d-table fs-18 lh-30 fw-500 text-dark-gray">Their team are easy to work with and helped me make amazing websites in a short amount of time. Thanks guys for all your hard work. Trust us we looked for a very long time.</span>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="row align-items-center justify-content-center">
                                            <div class="col-8 col-md-4 col-sm-6 text-center md-mb-30px">
                                                <img alt="" src="<?php echo base_url();?>assets/frontend/img/demo-corporate-testimonials-03.png">
                                            </div>
                                            <div class="col-lg-5 col-md-7 last-paragraph-no-margin text-center text-md-start">
                                                <a href="#" class="mb-15px d-block"><img src="<?php echo base_url();?>assets/frontend/img/logo-invision-dark-blue.svg" class="h-35px" alt=""></a>
                                                <span class="mb-5px d-table fs-18 lh-30 fw-500 text-dark-gray">Their team are easy to work with and helped me make amazing websites in a short amount of time. Thanks guys for all your hard work. Trust us we looked for a very long time.</span>
                    ...
                    <div class="row row-cols-1 row-cols-md-3 justify-content-center mb-6 md-mb-8 sm-mb-45px" data-anime='{ "el": "childs", "willchange": "transform", "perspective": [1200,1200], "translateY": [0, 0], "scale": [1.1, 1], "rotateX": [30, 0], "opacity": [0,1], "duration": 1000, "delay": 0, "staggervalue": 300, "easing": "easeOutQuad" }'>
                        <div class="col sm-mb-30px">
                            <div class="bg-white h-100 border-radius-6px text-center box-shadow-quadruple-large box-shadow-quadruple-large-hover">
                                <div class="pt-10 pb-10">
                                    <img src="<?php echo base_url();?>assets/frontend/img/logo-monday-dark-gray-02.svg" class="h-40px md-h-35px sm-h-40px" alt="" />
                                </div>
                        ...
                        <div class="col sm-mb-30px">
                            <div class="bg-white h-100 border-radius-6px text-center box-shadow-quadruple-large box-shadow-quadruple-large-hover">
                                <div class="pt-10 pb-10">
                                    <img src="<?php echo base_url();?>assets/frontend/img/logo-dropbox-dark-gray-02.svg" class="h-40px md-h-35px sm-h-40px" alt="" />
                                </div>
                        ...
                        <div class="col">
                            <div class="bg-white h-100 border-radius-6px text-center box-shadow-quadruple-large box-shadow-quadruple-large-hover">
                                <div class="pt-10 pb-10">
                                    <img src="<?php echo base_url();?>assets/frontend/img/logo-slack-dark-gray-02.svg" class="h-40px md-h-35px sm-h-40px" alt="" />
                                </div>
                                <div class="border-top fs-16 border-1 border-color-extra-medium-gray p-15px last-paragraph-no-margin">
                    ...
                    <div class="row row-cols-1 row-cols-lg-5 row-cols-md-3 row-cols-sm-2 clients-style-06 justify-content-center ps-3 pe-3 xs-mt-40px" data-anime='{ "el": "childs", "translateX": [50, 0], "opacity": [0,1], "duration": 1200, "delay": 0, "staggervalue": 150, "easing": "easeOutQuad" }'>
                        ...
                        <div class="col client-box text-center md-mb-40px">
                            <a href="#"><img src="<?php echo base_url();?>assets/frontend/img/logo-walmart-dark-blue.svg" class="h-45px" alt=""></a>
                        </div>
                        <!-- end client item -->
                        <!-- start client item -->
                        <div class="col client-box text-center md-mb-40px">
                            <a href="#"><img src="<?php echo base_url();?>assets/frontend/img/logo-netflix-dark-blue.svg" class="h-45px" alt=""></a>
                        </div>
                        <!-- end client item -->
                        <!-- start client item -->
                        <div class="col client-box text-center md-mb-40px">
                            <a href="#"><img src="<?php echo base_url();?>assets/frontend/img/logo-invision-dark-blue.svg" class="h-45px" alt=""></a>
                        </div>
                        <!-- end client item -->
                        <!-- start client item -->
                        <div class="col client-box text-center sm-mb-40px">
                            <a href="#"><img src="<?php echo base_url();?>assets/frontend/img/logo-yahoo-dark-blue.svg" class="h-45px" alt=""></a>
                        </div>
                        <!-- end client item -->
                        <!-- start client item -->
                        <div class="col client-box text-center">
                            <a href="#"><img src="<?php echo base_url();?>assets/frontend/img/logo-amazon-dark-blue.svg" class="h-45px" alt=""></a>
                        </div>
                        <!-- end client item -->
                    </div>
                </div>
            ...
            <section class="p-0">
                <div class="container">
                    <div class="row justify-content-center" data-anime='{ "translateY": [0, 0], "opacity": [0,1], "duration": 1200, "delay": 0, "staggervalue": 150, "easing": "easeOutQuad" }'>
                        <div class="col-12">
                            <div class="border-radius-6px h-450px md-h-350px sm-h-400px d-flex flex-wrap align-items-center justify-content-center overflow-hidden cover-background box-shadow-quadruple-large pt-15" style="background-image: url('images/demo-corporate-video-img.jpg')">
            ...
            <section>
                <div class="container">
                    ...
                    <div class="row align-items-end pricing-table-style-05 g-0 mb-6 background-position-center background-no-repeat justify-content-center" style="background-image: url('images/demo-corporate-bg-03.png')">
                            ...
                            <ul class="blog-grid blog-wrapper grid-loading grid grid-3col xl-grid-3col lg-grid-3col md-grid-2col sm-grid-2col xs-grid-1col gutter-extra-large"
                                ...
                                <li class="grid-item">
                                    <div class="card border-0 border-radius-5px box-shadow-quadruple-large box-shadow-quadruple-large-hover">
                                        <div class="blog-image">
                                            <a href="demo-corporate-blog-single-clean.html" class="d-block"><img src="images/demo-corporate-blog-01.jpg" alt="" /></a>
                                    ...
                                    <div
                                        ...
                                        <div class="blog-image">
                                            <a href="demo-corporate-blog-single-clean.html" class="d-block"><img
                                                    src="images/demo-corporate-blog-02.jpg" alt="" /></a>
                                            <div class="blog-categories">
                                ...
                                <li class="grid-item">
                                    <div
                                        class="card border-0 border-radius-5px box-shadow-quadruple-large box-shadow-quadruple-large-hover">
                                        <div class="blog-image">
                                            <a href="demo-corporate-blog-single-clean.html" class="d-block"><img src="images/demo-corporate-blog-03.jpg" alt="" /></a>
                                            <div class="blog-categories">
