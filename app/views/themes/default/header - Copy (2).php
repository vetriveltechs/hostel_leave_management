                                ...
                                <div class="container-fluid">
                                    <div class="d-lg-flex mega-menu flex-column w-100">
                                        <section class="--bg-solitude-blue pt-0">
                                                    ...
                                                    <?php 
                                                        foreach ($getCategoryListing as $categoryListing) 
                                                        {
                                                            ...
                                                            if ($categoryListing['cat_level_2'] !== NULL && $categoryListing['cat_level_2'] != 0) {
                                                                ...
                                                                ?>
                                                                    <li class="nav-item">
                                                                        <a class="nav-link text-dark" style="color:black!important;opacity:0px;" id="tab-four1-tab" onclick="mainCategoryLisiting(<?php echo $categoryListing['cat_level_1']?>)" href="#tab-four1"  >
                                                                        <?php echo $categoryListing['list_value']; ?><i class="fa-solid fa-arrow-right ms-5px " style="font-size:18px;"></i>
                                                                        </a>
                                                                    </li>
                                                                <?php
                                                            } 
                                            ...
                                            <script>
                                                function mainCategoryLisiting(category_level1_id) 
                                                {
                                                    $.ajax(
                                                    {
