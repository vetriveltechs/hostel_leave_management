<header>
    ...
    $getServiceBlog         = $this->categories_model->getServiceBlog();
    ...
    ?>
    <!-- start navigation -->
    <nav class="navbar navbar-expand-lg header-transparent --bg-transparent header-reverse mobile-header1" data-header-hover="light" style="background-color: black;">
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav alt-font">
                                            ...
                                            <div class="row align-items-center">
                                                ...
                                                <div class="col-xl-3 col-lg-4 col-md-12  tab-style-02 md-mb-30px sm-mb-20px">
                                                    ...
                                                    <ul class="nav nav-tabs --justify-content-center border-0 text-left fw-500 fs-18 alt-font category-tab" style="padding: 0 0px 0 0 !important;" id="myTab" role="tablist">
                                                        <?php
                                                            ...
                                                            foreach ($getServiceBlog as $serviceBlog) 
                                                            {
                                                                $category_level1_id = $serviceBlog['cat_level_1'];
                                                                $getSubCategory = $this->categories_model->getSubCategory($category_level1_id);

                                                                if ($serviceBlog['cat_level_2'] !== NULL) {
                                                                    if ($serviceBlog['cat_level_2'] != 0) {
                                                                        $categoryHref = "javascript:void(0)";
                                                                        $categoryOnclick = 'onclick="serviceBlogLisiting(' . $serviceBlog['cat_level_1'] . ', 0)"';
                                                                    } else {
                                                                        $categoryHref = base_url() . "blog-services-details/" . strtolower($serviceBlog['list_code']);
                                                                        $categoryOnclick = "";
                                                                    }
                                                                    ?>
                                                                        <li class="nav-item category-items">
                                                                            <a class="nav-link --text-dark serviceBlogCategory_a_tag" style="color:black!important; opacity:1;"
                                                                                id="serviceBlogCategory_link_<?php echo $serviceBlog['cat_level_1']; ?>"
                                                                                href="<?php echo $categoryHref; ?>"
                                                                                <?php echo $categoryOnclick; ?>>
                                                                                <?php echo $serviceBlog['list_value']; ?>
                                                                                <?php
                                                                                if ($serviceBlog['cat_level_2'] !== NULL && $serviceBlog['cat_level_2'] != 0) {
                                                                                ?>
                                                                                    <i class="fa-solid fa-arrow-right ms-5px" id="category-arrow-color-<?php echo $serviceBlog['cat_level_1']; ?>" style="font-size:18px;"></i>
                                                                                <?php
                                                                                }
                                                                                ?>
                                                                            </a>
                                                ...
                                                <script>
                                                    ...
                                                    function category() {
                                                        ...
                                                        if (segment_value !== "services-details" && segment_value !== "services-detail" && segment_value!=='blog-services' && segment_value!=='blog-services-details') 
                                                        {
                                                            mainCategoryLisiting('0', '0');
                                                        } 
                                                        else if(segment_value==='blog-services' || segment_value==='blog-services-details')
                                                        {
                                                            $.ajax({
                                                                url: '<?php echo base_url(); ?>welcome/getServicesSubCategoryValue/' + sec_segment_value + '/' + third_segment_value, // Ensure function name matches
                                                                type: 'GET',
                                                                dataType: 'json',
                                                                success: function(response) {
                                                                    if (response.category_level_id) {
                                                                        serviceBlogLisiting(response.category_level_id, response.category_level2_id); // Pass category_level_1
                                                                    } else {
                                                    ...
                                                    function serviceBlogLisiting(category_level1_id, category_level2_id) {
                                                        
                                                        $.ajax({
                                                            url: '<?php echo base_url(); ?>welcome/ajaxServiceBlogCategoryList/' + category_level1_id,
                                                            type: 'GET',
                                                            dataType: 'json',
                                                            success: function(response) {
                                                                ...
                                                                $('#serviceBlogCategory_link_' + response.category_level_id).css({
                                                                    'border-bottom': '2px solid #000',
                                                                    'color': '#5758d6'
                                                                    // 'font-weight': 'bold'  // Fixed missing comma
                                                                });
                        ...
                        <li class="nav-item dropdown dropdown-with-icon-style02">
                            <a href="javascript:void(0)" class="nav-link header1_links <?php echo ($segment_1 === 'about-us' || $segment_1 === "blog" || $segment_1 === 'success-story' || $segment_1 === 'events' || $segment_1 === 'careers' || $segment_1 === 'contact-us') ? 'header1_active_back_ground_color' : 'header1_back_ground_color'; ?>">Knowledge center</a>
                            <i class="fa-solid fa-angle-down dropdown-toggle" id="navbarDropdownMenuLink" role="button" data-bs-toggle="dropdown" aria-expanded="false"></i>
                            <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
...
<style>
    ...
    @media (max-width: 768px) {
        ...
        .sub_link_active_back_ground_color:hover {
            color: white !important;
            font-weight: bold !important;
        ...
        .sub_link_back_ground_color:hover {
            color: white !important;
            font-weight: bold !important;
            background-color: var(--base-color) !important;
