<body data-mobile-nav-style="classic" class="custom-cursor">
	<?php
		$getServicesHeaderList 	= $this->services_model->getServicesSubHeaderList($list_code_1);
		...
		if (count($getServicesHeaderList) > 0) 
		{
					...
					<div class="container">
						<div class="row extra-very-small-screen align-items-center">
							<div class="col-lg-5 col-sm-8 position-relative page-title-extra-small" data-anime='{ "el": "childs", "opacity": [0, 1], "translateX": [-30, 0], "duration": 800, "delay": 0, "staggervalue": 300, "easing": "easeOutQuad" }'>
								<h1 class="mb-20px xs-mb-20px text-white text-shadow-medium"><span class="w-30px h-2px bg-yellow d-inline-block align-middle position-relative top-minus-2px me-10px"></span><?php echo ucfirst($getServicesHeaderList[0]['main_category']); ?></h1>
								<h2 class="text-white text-shadow-medium fw-500 ls-minus-2px mb-0"><?php echo ucfirst($getServicesHeaderList[0]['list_value']); ?></h2>
							</div>
						</div>
					</div>
				</section>
					...
					<div class="container">
						<div class="row align-items-center justify-content-center" data-anime='{ " perspective": 1200 }'>
							...
							<div class="col-xl-5 offset-xl-1 col-lg-6 col-md-10" data-anime='{ "el": "childs", "translateY": [30, 0], "opacity": [0,1], "duration": 600, "delay": 0, "staggervalue": 300, "easing": "easeOutQuad" }'>
								...
								<h5 class="fw-600 text-dark-gray mb-20px ls-minus-2px alt-font">Why <?php echo ucfirst(SITE_NAME); ?>?</h5>
			...
			<?php
				...
				$getServicesLineList 	= $this->services_model->getServicesSubLineList($list_code_1);
							...
							<div class="container">
								<div class="row align-items-center">
									<div class="col-xl-5 col-lg-6 md-mb-50px" data-anime='{ "el": "childs", "translateY": [50, 0], "opacity": [0,1], "duration": 1200, "delay": 0, "staggervalue": 150, "easing": "easeOutQuad" }'>
										<h5 class="fw-700 text-dark-gray ls-minus-1px">Why Choose Us?</h5>
			...
			$getDetails = $this->services_model->getSubDetailsAll($list_code_1);
						...
						<div class="container-fluid">
							<div class="row justify-content-center mb-1">
								<div class=" col-lg-12  text-center" data-anime='{ "el": "childs", "translateY": [50, 0], "opacity": [0,1], "duration": 1200, "delay": 0, "staggervalue": 150, "easing": "easeOutQuad" }'>
									...
									<h4 class="fw-700 text-dark-gray ls-minus-1px"><?php echo ucfirst($getDetails[0]['title']); ?></h4>
			...
			$getBenefits = $this->services_model->getSubBenefitsAll($list_code_1);
				...
				?>
					...
					<section class="position-relative pt-0 overflow-hidden">
						...
						<!-- <div class="position-absolute top-30 right-minus-50px d-none d-md-inline-block">
							<img src="https://via.placeholder.com/160x200" data-bottom-top="transform: rotate(-10deg) translateY(-50px)" data-top-bottom="transform:rotate(10deg) translateY(50px)" alt="">
						</div> -->
						<div class="container position-relative">
							<div class="row align-items-center justify-content-center">
								...
								<div class="col-xl-5 col-lg-6 offset-xl-1" data-anime='{ "el": "childs", "translateY": [30, 0], "opacity": [0,1], "duration": 600, "delay": 0, "staggervalue": 300, "easing": "easeOutQuad" }'>
									<div class="bg-base-color fw-600 text-white text-uppercase ps-20px pe-20px fs-12 border-radius-100px d-inline-block mb-25px">Benifits</div>
									<h4 class="fw-700 alt-font text-dark-gray ls-minus-1px mb-50px sm-mb-30px">Problems We <span class="text-highlight">Solve.<span class="bg-base-color opacity-3 h-10px bottom-10px"></span></span></h4>
						...
						<div class="row justify-content-center align-items-center mb-9 sm-mb-45px">
							...
							<div class="col-lg-6 offset-xxl-1" data-anime='{ "el": "childs", "translateX": [50, 0], "opacity": [0,1], "duration": 1200, "delay": 0, "staggervalue": 150, "easing": "easeOutQuad" }'>
								<div class="contact-form-style-03 position-relative border-radius-10px bg-white p-14 lg-p-10 box-shadow-double-large overflow-hidden last-paragraph-no-margin">
									...
									<form action="<?php echo base_url(); ?>services-details/<?php echo strtolower($list_code_1); ?>" method="post" id="serviceForm" onsubmit="return submitForm(event);">
