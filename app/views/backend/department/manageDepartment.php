<?php
	...
	$getActiveDepartment 		= $this->department_model->getActiveDepartment('ALL'); 
					...
					<form action="" --class="form-validate-jquery" enctype="multipart/form-data" method="post">
						<div class="header-lines">
											...
											<div class="row">
												<div class="col-md-4">
													<div class="form-group text-right">
														<label class="col-form-label department_name"><span class="text-danger">*</span> Department Name</label>
													</div>
												</div>
												<div class="col-md-6">
													<div class="form-group role_id">
														<input type="text" id="department_name" name="department_name" required autocomplete="off" class="form-control" value="<?php echo isset($editData[0]['department_name']) ? $editData[0]['department_name'] :"";?>" placeholder="Department Name">
													</div>
												</div>
											</div>
											<div class="row">
												<div class="col-md-4">
													<div class="form-group text-right">
														<label class="col-form-label department_description"> Department Description</label>
													</div>
												</div>
												<div class="col-md-6">
													<div class="form-group">
														<textarea name="department_description" id="department_description" rows="1" autocomplete="off" class="form-control" placeholder="Department Description"><?php echo isset($editData[0]['department_description']) ? $editData[0]['department_description'] :"";?></textarea>
													</div>
												</div>
											</div>
							...
							<div class="col-md-12 mt-3 pr-0 text-right">
								...
								?>
								<a href="<?php echo base_url(); ?>department/ManageDepartment" class="btn btn-default btn-sm">Close</a>
							</div>
						</div>
					</form>
					...
					<div class="row">
						...
						<div class="col-md-6 float-right text-right">
							...
							<?php
								...
								{
									?>
									<a href="<?php echo base_url(); ?>department/ManageDepartment/add" class="btn btn-info btn-sm">
										Create Department
									</a>
									<?php
								}
					...
					<form action="" class="form-validate-jquery" method="get">
						<div class="row mt-3">
							...
							<div class="col-md-2">
								...
								<a href="<?php echo base_url(); ?>department/ManageDepartment" title="Clear" class="btn btn-default">Clear</a>
							</div>
						</div>
					</form>
					<!-- Filters end here -->
								...
								<table id="myTable" class="table table-bordered table-hover tbl_height">
									<thead>
										<tr>
											...
											<th class="text-left tab-md-140">Department Name</th>
											<th class="text-left tab-md-140">Department Description</th>
										...
										<?php
											...
											foreach($resultData as $row)
											{
												...
												<td class="text-center">
																	...
																	{ 
																		...
																		<?php
																			if($physical_stock_adjustment['create_edit_only'] == 1 || $this->user_id == 1)
																			{
																				?>
																					<li>
																						<a title="Edit" href="<?php echo base_url(); ?>department/ManageDepartment/edit/<?php echo $row['department_id'];?>/">
																		...
																		<?php
																			if($physical_stock_adjustment['read_only'] == 1 || $this->user_id == 1)
																			{
																				...
																				?>
																				<li>
																					<a title="View" href="<?php echo base_url(); ?>department/ManageDepartment/view/<?php echo $row['department_id'];?>/">
																			...
																			if($physical_stock_adjustment['create_edit_only'] == 1 || $this->user_id == 1)
																			{
																				...
																				<li>
																					<?php 
																						...
																						{
																							?>
																							<a class="unblock" href="<?php echo base_url(); ?>department/ManageDepartment/status/<?php echo $row['department_id'];?>/N" title="Inactive">
																						...
																						{  ?>
																							<a class="block" href="<?php echo base_url(); ?>department/ManageDepartment/status/<?php echo $row['department_id'];?>/Y" title="Active">
													...
													<td><?php echo ucfirst($row['department_description']);?></td>
													<td class="text-center">
														<?php 
															if($row['active_flag'] == $this->active_flag)
															{
