				...
				if(isset($type) && $type == "add" || $type == "edit" || $type == "view")
				{
						...
						<div class="header-lines">
							...
							<div class="row mb-3">
								...
								<div class="col-md-6 text-right">
									...
									<a href="<?php echo base_url(); ?>products/manageBenefits" class="btn btn-default btn-sm">Close</a>
								</div>
							</div>
							<!-- Buttons end here -->
									...
									<div class="row">
										<div class="col-md-6">
											...
											<div class="row">
												<div class="col-md-4">
													<div class="form-group text-right">
														<label class="col-form-label benefits_banner_image"><span class="text-danger">*</span> Image</label>
													</div>				
												</div>
												<div class="col-md-4">
													<div class="form-group">
														<input type="file" name="benefits_banner_image" id="benefits_banner_image" onchange='validateImage(this)' accept='.png, .gif, .jpg, .jpeg, .bmp' class="form-control singleImage">
														<span class="exist_error text-warning"></span>
														<?php 
															if( ($type == "edit" || $type == "view") && isset($id))
															{
																$url = "uploads/products/benefits/banner/".$id.".png";
																if(file_exists($url))
																{
																	?><br>
																...
																<tr class="remove_tr tabRow<?php echo $counter;?>">
																	...
																	<td class="tab-md-85">
																		...
																		<?php 
																			...
																			{
																				$url = "uploads/products/benefits/".$lineItems["line_id"].".png";
																				if(file_exists($url))
																				{
																					?>
					...
					<script>
						function updateStatus(checkbox, id) 
						{
							...
							$.ajax({
								type: "GET",
								url: "<?php echo base_url().'products/ajaxAvailableBenefits/status/';?>" + id + "/" + status,
								data: {}
							}).done(function(msg) 
							{
								toastr.success(msg);
						...
						function saveBtn(val) {
							...
							var title 					= $("#title").val();
							var benefits_banner_image 	= $("#benefits_banner_image").val();


							if (product_id && title && (type !== 'add' || benefits_banner_image)) 
							{

								$(".product_id").removeClass('errorClass');
								$(".title").removeClass('errorClass');
								$(".benefits_banner_image").removeClass('errorClass');
								...
								if (type === 'add' && !benefits_banner_image) {
									$(".benefits_banner_image").addClass('errorClass');
								} else {
									$(".benefits_banner_image").removeClass('errorClass');
								}
				...
				{ 
					...
					<div class="row">
						...
						<div class="col-md-6 float-right text-right">
							<a href="<?php echo base_url(); ?>products/manageBenefits/add" class="btn btn-info btn-sm">
								Create Benefit
							</a>
							<?php /*
					...
					<form action="" class="form-validate-jquery" method="get">
						...
						<div class="row">
							<div class="col-md-12 text-right float-right">
								...
								<a href="<?php echo base_url(); ?>products/manageBenefits" title="Clear" class="btn btn-default">Clear</a>
							</div>
						</div>
													...
													<tr>
														<td  class='text-center' style="width:90px;">
															<div class="dropdown" style="width:90px;">
																...
																<ul class="dropdown-menu dropdown-menu-right dropdown-menu-new">
																	<li>
																		<a href="<?php echo base_url(); ?>products/manageBenefits/edit/<?php echo $row['header_id'];?>">
																			<i class="fa fa-pencil"></i> Edit
																		</a>
																	</li>
																	
																	<li>
																		<a href="<?php echo base_url(); ?>products/manageBenefits/view/<?php echo $row['header_id'];?>">
																	...
																	<li>
																		<?php 
																			...
																			{
																				?>
																				<a class="unblock" href="<?php echo base_url(); ?>products/manageBenefits/status/<?php echo $row['header_id'];?>/N" title="Inactive">
																			...
																			{  ?>
																				<a class="block" href="<?php echo base_url(); ?>products/manageBenefits/status/<?php echo $row['header_id'];?>/Y" title="Active">
														...
														<td class="text-center">
															<?php 
																...
																{
																	$url = "uploads/products/benefits/banner/".$row['header_id'].".png";
																	if(file_exists($url))
																	{
																		?>
