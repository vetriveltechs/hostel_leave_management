				...
				if(isset($type) && $type == "add" || $type == "edit" || $type == "view")
				{
						...
						<div class="header-lines">
							...
							<div class="row mb-3">
								...
								<div class="col-md-6 text-right">
									...
									<a href="<?php echo base_url(); ?>services/manageDetails" class="btn btn-default btn-sm">Close</a>
								</div>
							</div>
							<!-- Buttons end here -->
														...
														if( count($lineData) > 0)
														{
															...
															foreach($lineData as $lineItems)
															{
																...
																<tr class="remove_tr tabRow<?php echo $counter;?>">
																	...
																	<td class="tab-md-85">
																		<input type="file" name="benefits_image[]" id="benefits_image" class="form-control singleImage" onchange='validateImage(this)' accept='.png, .gif, .jpg, .jpeg, .bmp'>
																		<?php 
																			if( ($type == "edit" || $type == "view") && isset($lineItems["line_id"]))
																			{
																				$url = "uploads/services/details/".$lineItems["line_id"].".png";
																				if(file_exists($url))
																				{
																					?>
																					<?php /*
					...
					<script>
						...
						function updateStatus(checkbox, id) 
						{
							...
							$.ajax({
								type: "GET",
								url: "<?php echo base_url().'services/ajaxAvailableDetails/status/';?>" + id + "/" + status,
								data: {}
							}).done(function(msg) 
							{
								toastr.success(msg);
						...
						function saveBtn(val) {
							...
							if (category_id && title && description) 
							{
								...
								$("table.line_items").find('tr').each(function () {
									...
									if (line_title === "" || line_description === "" || (benefits_image === "" && type !== 'edit')) 
									{
										lineIncomplete = true;
										return false;
									}
							...
							$.ajax({
								...
								success: function(d)
								{
									...
									if(flag == 0)
									{
										...
										cols += "<td class='tab-md-150'>" 
											+"<input type='file' class='form-control' name='benefits_image[]' id='benefits_image"+ counter +"' value='' onchange='validateImage(this)' accept='.png, .gif, .jpg, .jpeg, .bmp'></input>"
										+"</td>";
				...
				{ 
					...
					<div class="row">
						...
						<div class="col-md-6 float-right text-right">
							<a href="<?php echo base_url(); ?>services/manageDetails/add" class="btn btn-info btn-sm">
								Create Detail
							</a>
							<?php /*
					...
					<form action="" class="form-validate-jquery" method="get">
						...
						<div class="row">
							<div class="col-md-12 text-right float-right">
								...
								<a href="<?php echo base_url(); ?>services/manageDetails" title="Clear" class="btn btn-default">Clear</a>
							</div>
						</div>
														...
														<td  class='text-center' style="width:90px;">
															<div class="dropdown" style="width:90px;">
																...
																<ul class="dropdown-menu dropdown-menu-right dropdown-menu-new">
																	...
																	<li>
																		<a href="<?php echo base_url(); ?>services/manageDetails/edit/<?php echo $row['header_id'];?>">
																			<i class="fa fa-pencil"></i> Edit
																		</a>
																	</li>
																	
																	<li>
																		<a href="<?php echo base_url(); ?>services/manageDetails/view/<?php echo $row['header_id'];?>">
																	...
																	<li>
																		<?php 
																			...
																			{
																				?>
																				<a class="unblock" href="<?php echo base_url(); ?>services/manageDetails/status/<?php echo $row['header_id'];?>/N" title="Inactive">
																			...
																			{  ?>
																				<a class="block" href="<?php echo base_url(); ?>services/manageDetails/status/<?php echo $row['header_id'];?>/Y" title="Active">
