				...
				if(isset($type) && $type == "add" || $type == "edit" || $type == "view")
				{
						...
						<div class="header-lines">
							...
							<div class="row mb-3">
								...
								<div class="col-md-6 text-right">
									...
									<a href="<?php echo base_url(); ?>services/manageBenefits" class="btn btn-default btn-sm">Close</a>
								</div>
							</div>
							<!-- Buttons end here -->
											...
											<div class="row">
												<div class="col-md-4">
													<div class="form-group text-right">
														<label class="col-form-label category_id"><span class="text-danger">*</span> Category</label>
													</div>				
												</div>
												<div class="col-md-5">
												...
												<div class="col-md-4">
													<div class="form-group">
														...
														<?php 
															...
															{
																$url = "uploads/services/benefits/banner/".$id.".png";
																if(file_exists($url))
																{
																	?><br>
																...
																<tr class="remove_tr tabRow<?php echo $counter;?>">
																	...
																	<td class="tab-md-85">
																		...
																		<?php 
																			...
																			{
																				$url = "uploads/services/benefits/".$lineItems["line_id"].".png";
																				if(file_exists($url))
																				{
																					?>
					...
					<script>
						...
						function updateStatus(checkbox, id) 
						{
							...
							$.ajax({
								type: "GET",
								url: "<?php echo base_url().'services/ajaxAvailableBenefits/status/';?>" + id + "/" + status,
								data: {}
							}).done(function(msg) 
							{
								toastr.success(msg);
						...
						function saveBtn(val) {
							...
							if (category_id && (type !== 'add' || benefits_banner_image)) 
							{
				...
				{ 
					...
					<div class="row">
						...
						<div class="col-md-6 float-right text-right">
							<a href="<?php echo base_url(); ?>services/manageBenefits/add" class="btn btn-info btn-sm">
								Create Benefit
							</a>
							<?php /*
					...
					<form action="" class="form-validate-jquery" method="get">
						<div class="row mt-3">
							<div class="col-md-4">
								<div class="row">
									<label class="col-form-label col-md-5">Category Name</label>
							...
							<div class="col-md-2">
								...
								<a href="<?php echo base_url(); ?>services/manageBenefits" title="Clear" class="btn btn-default">Clear</a>
							</div>
						</div>
														...
														<td  class='text-center' style="width:90px;">
															<div class="dropdown" style="width:90px;">
																...
																<ul class="dropdown-menu dropdown-menu-right dropdown-menu-new">
																	<li>
																		<a href="<?php echo base_url(); ?>services/manageBenefits/edit/<?php echo $row['header_id'];?>" title="Edit">
																			<i class="fa fa-pencil"></i> Edit
																		</a>
																	</li>
																	
																	<li>
																		<a href="<?php echo base_url(); ?>services/manageBenefits/view/<?php echo $row['header_id'];?>" title="View">
																	...
																	<li>
																		<?php 
																			...
																			{
																				?>
																				<a class="unblock" href="<?php echo base_url(); ?>services/manageBenefits/status/<?php echo $row['header_id'];?>/N" title="Inactive">
																			...
																			{  ?>
																				<a class="block" href="<?php echo base_url(); ?>services/manageBenefits/status/<?php echo $row['header_id'];?>/Y" title="Active">
																		...
																		<ul class="dropdown-menu dropdown-menu-right dropdown-menu-new">
																			...
																			<?php
																				if($item_details['create_edit_only'] == 1 || $this->user_id == 1)
																				{
																					?>
																					<li>
																						<a href="<?php echo base_url(); ?>services/manageBenefits/edit/<?php echo $row['header_id'];?>">
																							<i class="fa fa-pencil"></i> Edit
																						</a>
																					</li>
																					<?php 
																			...
																			<?php
																				if($item_details['read_only'] == 1 || $this->user_id == 1)
																				{
																					?>
																					<li>
																						<a href="<?php echo base_url(); ?>services/manageBenefits/view/<?php echo $row['header_id'];?>">
																							<i class="fa fa-eye"></i> View
																						</a>
																					</li>
														...
														*/ ?>
														<td class="text-center">
															<?php 
																...
																{
																	$url = "uploads/services/benefits/banner/".$row['header_id'].".png";
																	if(file_exists($url))
																	{
																		?>
