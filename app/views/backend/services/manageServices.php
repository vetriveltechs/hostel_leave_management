				...
				if(isset($type) && $type == "add" || $type == "edit" || $type == "view")
				{
						...
						<div class="header-lines">
							...
							<div class="row mb-3">
								...
								<div class="col-md-6 text-right">
									...
									<a href="<?php echo base_url(); ?>services/manageServices" class="btn btn-default btn-sm">Close</a>
								</div>
							</div>
							<!-- Buttons end here -->
									...
									<div class="row">
										<div class="col-md-6">
											<div class="row">
												<div class="col-md-4">
													<div class="form-group text-right">
														<label class="col-form-label service_name"><span class="text-danger">*</span> Service Name</label>
													</div>				
												</div>
												<div class="col-md-4">
													<div class="form-group">
														<input type="text" name="service_name" id="service_name" placeholder="Service Name" class="form-control" value="<?php echo isset($headerData[0]['service_name']) ? $headerData[0]['service_name'] : NULL;?>"></input>
													</div>				
												</div>
											</div>
											<div class="row">
												<div class="col-md-4">
													<div class="form-group text-right">
														<label class="col-form-label category_id"><span class="text-danger">*</span> Category Name</label>
													</div>				
												</div>
												<div class="col-md-4">
													<div class="form-group">
														<select name="category_id" id="category_id" class="form-control <?php echo $searchDropdown;?>" required>
															...
															<?php 
																...
																{
																	$selected="";
																	if(isset($headerData[0]['category_id']) && ($headerData[0]['category_id'] == $category['category_id']) )
																	{
											...
											<div class="row">
												<div class="col-md-4">
													<div class="form-group text-right">
														<label class="col-form-label service_image"><span class="text-danger">*</span> Service Image</label>
													</div>
												</div>
												<div class="col-md-5">
													<div class="form-group">
														<input type="file" name="service_image" id="service_image" onchange='validateImage(this)' accept='.png, .gif, .jpg, .jpeg, .bmp' class="form-control singleImage">
															...
															<?php 
																...
																{
																	$url = "uploads/services/service_images/".$id.".png";
																	if(file_exists($url))
																	{
																		?><br>
													...
													<div class="form-group">
														<input type="file" name="banner_image" id="banner_image" onchange='validateImage(this)' accept='.png, .gif, .jpg, .jpeg, .bmp' class="form-control singleImage">
															...
															<?php 
																if( ($type == "edit" || $type == "view") && isset($id))
																{
																	$url = "uploads/services/banner/".$id.".png";
																	if(file_exists($url))
																	{
																		?><br>
																		<div class="form-group view-form row">
											...
											<div class="row">
												<div class="col-md-4">
													<div class="form-group text-right">
														<label class="col-form-label contact_title"><span class="text-danger">*</span> Contact Title</label>
													</div>				
												</div>
												<div class="col-md-4">
													<div class="form-group">
														<input type="text" name="contact_title" id="contact_title" placeholder="Contact Title" class="form-control" value="<?php echo isset($headerData[0]['contact_title']) ? $headerData[0]['contact_title'] : NULL;?>"></input>
													</div>				
												</div>
											</div>
											<div class="row">
												<div class="col-md-4">
													<div class="form-group text-right">
														<label class="col-form-label contact_description"><span class="text-danger">*</span> Contact Description</label>
													</div>				
												</div>
												<div class="col-md-4">
													<div class="form-group">
														<textarea name="contact_description" id="contact_description" cols="" rows="1" placeholder="Contact Description" class="form-control"><?php echo isset($headerData[0]['contact_description']) ? $headerData[0]['contact_description'] : NULL;?></textarea>
													</div>				
												</div>
											</div>
										</div>
										...
										<div class="col-md-6">
											<div class="row">
												...
												<div class="col-md-4">
													<div class="form-group">
														<textarea name="overview" id="overview" cols="" rows="1" placeholder="Overview" class="form-control"><?php echo isset($headerData[0]['overview']) ? $headerData[0]['overview'] : NULL;?></textarea>
													</div>				
												</div>
											</div>
											<div class="row">
													...
													<div class="form-group">
														<input type="file" name="overview_image" id="overview_image" onchange='validateImage(this)' accept='.png, .gif, .jpg, .jpeg, .bmp' class="form-control singleImage">
															...
															<?php 
																if( ($type == "edit" || $type == "view") && isset($id))
																{
																	$url = "uploads/services/overviews/".$id.".png";
																	if(file_exists($url))
																	{
																		?><br>
																		<div class="form-group view-form row">
											...
											<div class="row">
												<div class="col-md-4">
													<div class="form-group text-right">
														<label class="col-form-label why_jesperapps"><span class="text-danger">*</span> Why Jesperapps</label>
													</div>				
												</div>
												<div class="col-md-4">
													<div class="form-group">
														<textarea name="why_jesperapps" id="why_jesperapps" cols="" rows="1" placeholder="Why Jesperapps" class="form-control"><?php echo isset($headerData[0]['why_jesperapps']) ? $headerData[0]['why_jesperapps'] : NULL;?></textarea>
													</div>				
												</div>
											</div>
											<div class="row">
												<div class="col-md-4">
													<div class="form-group text-right">
														<label class="col-form-label why_choose_image"><span class="text-danger">*</span> Why Choose Image</label>
													</div>
												</div>
												<div class="col-md-4">
													<div class="form-group">
														<input type="file" name="why_choose_image" id="why_choose_image" onchange='validateImage(this)' accept='.png, .gif, .jpg, .jpeg, .bmp' class="form-control singleImage">
															<span class="text-muted" ></span>
															<span class="exist_error text-warning"></span>
															...
															<?php 
																if( ($type == "edit" || $type == "view") && isset($id))
																{
																	$url = "uploads/services/why_choose_images/".$id.".png";
																	if(file_exists($url))
																	{
																		?><br>
																		<div class="form-group view-form row">
											...
											<?php /*
												<div class="row">
													<div class="col-md-4">
														<div class="form-group text-right">
															<label class="col-form-label why_choose_icon_image"><span class="text-danger">*</span> Why Icon Image</label>
														</div>
													</div>
													<div class="col-md-4">
														<div class="form-group">
															<input type="file" name="why_choose_icon_image" id="why_choose_icon_image" onchange='validateImage(this)' accept='.png, .gif, .jpg, .jpeg, .bmp' class="form-control singleImage">
																<span class="text-muted" ></span>
																<span class="exist_error text-warning"></span>
																...
																<?php 
																	if( ($type == "edit" || $type == "view") && isset($id))
																	{
																		$url = "uploads/services/why_choose_images/why_choose_icon_images/".$id.".png";
																		if(file_exists($url))
																		{
																			?><br>
																			<div class="form-group view-form row">
														...
														if( count($lineData) > 0)
														{
															...
															foreach($lineData as $lineItems)
															{
																...
																<tr class="remove_tr tabRow<?php echo $counter;?>">
																	...
																	<?php /*
																	<td class="tab-md-85">
																		<input type="file" name="benefits_image[]" id="benefits_image" class="form-control singleImage" onchange='validateImage(this)'>
																		<?php 
																			if( ($type == "edit" || $type == "view") && isset($lineItems["line_id"]))
																			{
																				$url = "uploads/services/".$lineItems["line_id"].".png";
																				if(file_exists($url))
																				{
																					?>
					...
					<script>
						function updateStatus(checkbox, id) 
						{
							...
							$.ajax({
								type: "GET",
								url: "<?php echo base_url().'services/ajaxAvailableServices/status/';?>" + id + "/" + status,
								data: {}
							}).done(function(msg) 
							{
								toastr.success(msg);
						...
						function saveBtn(val) {
							...
							var why_jesperapps 			= $("#why_jesperapps").val();
							...
							var why_choose_image 		= $("#why_choose_image").val();
							// var why_choose_icon_image 	= $("#why_choose_icon_image").val();


							if (service_name && category_id && overview && why_jesperapps && contact_title && contact_description && (type !== 'add' || service_image) && (type !== 'add' || banner_image) && (type !== 'add' || overview_image) && (type !== 'add' || why_choose_image)) 
							{
								$(".service_name").removeClass('errorClass');
								$(".category_id").removeClass('errorClass');
								$(".overview").removeClass('errorClass');
								$(".why_jesperapps").removeClass('errorClass');
								$(".contact_title").removeClass('errorClass');
								$(".contact_description").removeClass('errorClass');
								$(".service_image").removeClass('errorClass');
								$(".banner_image").removeClass('errorClass');
								$(".overview_image").removeClass('errorClass');
								$(".why_choose_image").removeClass('errorClass');
								// $(".why_choose_icon_image").removeClass('errorClass');
								...
								$("table.line_items").find('tr').each(function () {
									...
									// var benefits_image    	= row.find('input[name^="benefits_image[]"]').val();
							...
							{
								if (!service_name) $(".service_name").addClass('errorClass');
								else $(".service_name").removeClass('errorClass');

								if (!category_id) $(".category_id").addClass('errorClass');
								else $(".category_id").removeClass('errorClass');

								if (!overview) $(".overview").addClass('errorClass');
								else $(".overview").removeClass('errorClass');

								if (!why_jesperapps) $(".why_jesperapps").addClass('errorClass');
								else $(".why_jesperapps").removeClass('errorClass');

								if (!contact_title) $(".contact_title").addClass('errorClass');
								else $(".contact_title").removeClass('errorClass');

								if (!contact_description) $(".contact_description").addClass('errorClass');
								else $(".contact_description").removeClass('errorClass');

								if (!service_image) $(".service_image").addClass('errorClass');
								else $(".service_image").removeClass('errorClass');
							
								if (!banner_image) $(".banner_image").addClass('errorClass');
								else $(".banner_image").removeClass('errorClass');

								if (!overview_image) $(".overview_image").addClass('errorClass');
								else $(".overview_image").removeClass('errorClass');
								
								if (!why_choose_image) $(".why_choose_image").addClass('errorClass');
								else $(".why_choose_image").removeClass('errorClass');

								// if (!why_choose_icon_image) $(".why_choose_icon_image").addClass('errorClass');
								// else $(".why_choose_icon_image").removeClass('errorClass');
							...
							$.ajax({
								...
								success: function(d)
								{
									...
									if(flag == 0)
									{
										...
										// cols += "<td class='tab-md-150'>" 
										// 	+"<input type='file' class='form-control' name='benefits_image[]' id='benefits_image"+ counter +"' value='' onchange='validateImage(this)'></input>"
										// +"</td>";
				...
				{ 
					...
					<div class="row">
						...
						<div class="col-md-6 float-right text-right">
							<a href="<?php echo base_url(); ?>services/manageServices/add" class="btn btn-info btn-sm">
								Create Service
							</a>
							<?php /*
					...
					<form action="" class="form-validate-jquery" method="get">
						<div class="row mt-3">
							...
							<div class="col-md-4">
								<div class="row">
									<label class="col-form-label col-md-5">Service Name</label>
									<div class="form-group col-md-7">
										<input type="search" name="service_name" autocomplete="off" id="service_name" value="<?php echo isset($_GET['service_name']) ? $_GET['service_name'] : NULL; ?>" placeholder="Service Title" class="form-control">
									</div>
								</div>
							</div>
							<div class="col-md-4">
									...
									<table id="myTable" class="table table-bordered table-hover tbl_height">
										<thead>
											<tr>
												...
												<th class="tab-md-140">Service Name</th>
												<th class="tab-md-140">Category Name</th>
												<th class="tab-md-140">Overview</th>
												<th class="tab-md-140">Image</th>
											...
											<?php 	
												...
												foreach($resultData as $row)
												{
													...
													<tr>
														<td  class='text-center' style="width:90px;">
															<div class="dropdown" style="width:90px;">
																...
																<ul class="dropdown-menu dropdown-menu-right dropdown-menu-new">
																			...
																			<li>
																				<a href="<?php echo base_url(); ?>services/manageServices/edit/<?php echo $row['header_id'];?>">
																					<i class="fa fa-pencil"></i> Edit
																				</a>
																			</li>
																			
																			<li>
																				<a href="<?php echo base_url(); ?>services/manageServices/view/<?php echo $row['header_id'];?>">
																			...
																			<li>
																				<?php 
																					...
																					{
																						?>
																						<a class="unblock" href="<?php echo base_url(); ?>services/manageServices/status/<?php echo $row['header_id'];?>/N" title="Inactive">
																					...
																					{  ?>
																						<a class="block" href="<?php echo base_url(); ?>services/manageServices/status/<?php echo $row['header_id'];?>/Y" title="Active">
														...
														<td><?php echo ucfirst($row['overview']);?></td>
														<td>
															<?php 
																if(isset($row['header_id']))
																{
																	$url = "uploads/services/service_images/".$row['header_id'].".png";
																	if(file_exists($url))
																	{
																		?>
