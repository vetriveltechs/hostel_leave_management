					...
					<div class="row">
						<div class="col-md-4">
							<div class="row">
								...
								<input type="saerch" name="keywords" autocomplete="off" id="keywords" value="<?php echo isset($_GET['keywords']) ? $_GET['keywords'] : NULL; ?>" placeholder="First Name / Company Email / Company Name" class="form-control">
								</div>
							</div>
						...
						<table id="myTable" class="table table-bordered table-hover">
							<thead>
								<tr>
									...
									<th class="tab-md-140">Company Name</th>
									<th class="tab-md-140">Company Email</th>
									<th class="tab-md-140">Message</th>
