				...
				if(isset($type) && $type == "add" || $type == "edit" || $type == "view")
				{
						...
						<div class="header-lines">
							...
							<div class="row mb-3">
								...
								<div class="col-md-6 text-right">
									...
									<a href="<?php echo base_url(); ?>industries/manageBenefits" class="btn btn-default btn-sm">Close</a>
								</div>
							</div>
							<!-- Buttons end here -->
									...
									<div class="row">
										<div class="col-md-6">
											...
											<div class="row">
												...
												<div class="col-md-4">
													<div class="form-group">
														<input name="title" id="title" placeholder="Title" class="form-control" value="<?php echo isset($headerData[0]['title']) ? $headerData[0]['title'] : NULL;?>"></input>
													</div>				
												</div>
											</div>
											<!-- <div class="row">
												...
												<div class="col-md-4">
													<div class="form-group">
														<textarea name="description" id="description" rows="1" placeholder="Description" class="form-control"><?php echo isset($headerData[0]['description']) ? $headerData[0]['description'] : NULL;?></textarea>
													</div>				
												</div>
											</div> -->
											...
											<div class="row">
												<div class="col-md-4">
													<div class="form-group text-right">
														<label class="col-form-label benefits_image"><span class="text-danger">*</span> Image</label>
													</div>				
												</div>
												<div class="col-md-4">
													<div class="form-group">
														<input type="file" name="benefits_image" id="benefits_image" onchange='validateImage(this)' accept='.png, .gif, .jpg, .jpeg, .bmp' class="form-control singleImage">
														<span class="exist_error text-warning"></span>
														<?php 
															if( ($type == "edit" || $type == "view") && isset($id))
															{
																$url = "uploads/industries/benefits/".$id.".png";
																if(file_exists($url))
																{
																	?><br>
					...
					<script>
						...
						function updateStatus(checkbox, id) 
						{
							...
							$.ajax({
								type: "GET",
								url: "<?php echo base_url().'industries/ajaxAvailableBenefits/status/';?>" + id + "/" + status,
								data: {}
							}).done(function(msg) 
							{
								toastr.success(msg);
						...
						function saveBtn(val) {
							...
							var benefits_image 	= $("#benefits_image").val();

							
							if (industries_id && title && (type !== 'add' || benefits_image)) 
							{

								$(".industries_id").removeClass('errorClass');
								$(".title").removeClass('errorClass');
								// $(".description").removeClass('errorClass');
								$(".benefits_image").removeClass('errorClass');
								...
								if (type === 'add' && !benefits_image) {
									$(".benefits_image").addClass('errorClass');
								} else {
									$(".benefits_image").removeClass('errorClass');
								}
								return false;
				...
				{ 
					...
					<div class="row">
						...
						<div class="col-md-6 float-right text-right">
							<a href="<?php echo base_url(); ?>industries/manageBenefits/add" class="btn btn-info btn-sm">
								Create Benefit
							</a>
							<?php /*
					...
					<form action="" class="form-validate-jquery" method="get">
						<div class="row mt-3">
							...
							<div class="col-md-4">
								<div class="row">
									...
									<div class="form-group col-md-7">
										<input type="search" name="title" autocomplete="off" id="title" value="<?php echo isset($_GET['title']) ? $_GET['title'] : NULL; ?>" placeholder="Title" class="form-control">
									</div>
								</div>
							</div>
							<div class="col-md-4">
						...
						<div class="row">
							<div class="col-md-12 text-right float-right">
								...
								<a href="<?php echo base_url(); ?>industries/manageBenefits" title="Clear" class="btn btn-default">Clear</a>
							</div>
						</div>
									...
									<table id="myTable" class="table table-bordered table-hover tbl_height">
										<thead>
											<tr>
												...
												<th class="tab-md-140">Industry Name</th>
													...
													<tr>
														<td  class='text-center' style="width:90px;">
															<div class="dropdown" style="width:90px;">
																...
																<ul class="dropdown-menu dropdown-menu-right dropdown-menu-new">
																	...
																	<li>
																		<a href="<?php echo base_url(); ?>industries/manageBenefits/edit/<?php echo $row['header_id'];?>">
																			<i class="fa fa-pencil"></i> Edit
																		</a>
																	</li>
																	
																	<li>
																		<a href="<?php echo base_url(); ?>industries/manageBenefits/view/<?php echo $row['header_id'];?>">
																	...
																	<li>
																		<?php 
																			...
																			{
																				?>
																				<a class="unblock" href="<?php echo base_url(); ?>industries/manageBenefits/status/<?php echo $row['header_id'];?>/N" title="Inactive">
																			...
																			{  ?>
																				<a class="block" href="<?php echo base_url(); ?>industries/manageBenefits/status/<?php echo $row['header_id'];?>/Y" title="Active">
														...
														<td class="text-center">
															<?php 
																...
																{
																	$url = "uploads/industries/benefits/".$row['header_id'].".png";
																	if(file_exists($url))
																	{
																		?>
