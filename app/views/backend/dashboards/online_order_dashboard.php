	...
	<!-- <div class="row">
		<div class="col-md-12">
			<div class="page-title-box2">
				...
				?>
				<h4 class="page-title page-title-dashboard">
					Welcome <?php echo isset($edit_data1[0]['first_name']) ? ucfirst($edit_data1[0]['first_name']) :"";?> !

					<a style="font-size:16px;padding:0px 14px 0px 0px;" href="<?php echo base_url();?>admin/home" class="text-right float-right">
