				...
				if(isset($type) && $type == "add" || $type == "edit" || $type == "view")
				{
						...
						<div class="header-lines">
							...
							<div class="row mb-3">
								...
								<div class="col-md-6 text-right">
									...
									<a href="<?php echo base_url(); ?>caseStudies/manageOurSolutions" class="btn btn-default btn-sm">Close</a>
								</div>
							</div>
							<!-- Buttons end here -->
									...
									<div class="row">
										<div class="col-md-6">
												...
												<div class="col-md-5">
													<div class="form-group">
														<div class="input-wrapper">
																<input type="text" name="casestudy_title" autocomplete="off" id="casestudy_title" value="<?php echo isset($headerData[0]['casestudy_title']) ? $headerData[0]['casestudy_title'] : NULL; ?>" placeholder="Casestudy Title" class="form-control">
											...
											<div class="row">
												...
												<div class="col-md-4">
													<div class="form-group">
														<input type="text" name="title" id="title" autocomplete="off" class="form-control" value="<?php echo isset($headerData[0]['title']) ? $headerData[0]['title'] :"";?>" placeholder="Title">
													</div>				
												</div>
											</div>
											...
											<div class="row">
												...
												<div class="col-md-4">
													<div class="form-group">
														<input type="file" name="solution_image" id="solution_image" onchange='validateImage(this)' accept="image/*" class="form-control singleImage">
														<span class="exist_error text-warning"></span>
														<?php 
															if( ($type == "edit" || $type == "view") && isset($id))
															{
																$overview_url = "uploads/case_studies/solutions/".$id.".png";
					...
					<script>
						...
						function updateStatus(checkbox, id) 
						{
							...
							$.ajax({
								type: "GET",
								url: "<?php echo base_url().'caseStudies/ajaxAvailableOurSolution/status/';?>" + id + "/" + status,
								data: {}
							}).done(function(msg) 
							{
								toastr.success(msg);
						...
						function saveBtn(val) {
							...
							if (casestudies_id && title && (type !== 'add' || solution_image) ) 
							{
								...
								if (type === 'add' && !solution_image) {
									$(".solution_image").addClass('errorClass');
								} else {
									$(".solution_image").removeClass('errorClass');
								}
				...
				{ 
					...
					<div class="row">
						...
						<div class="col-md-6 float-right text-right">
							<a href="<?php echo base_url(); ?>caseStudies/manageOurSolutions/add" class="btn btn-info btn-sm">
								Create Solution
							</a>
					...
					<form action="" class="form-validate-jquery" method="get">
						<div class="row mt-3">
							...
							<div class="col-md-4">
								<div class="row">
									...
									<div class="form-group col-md-7">
										<input type="text" name="title" autocomplete="off" id="title" value="<?php echo isset($_GET['title']) ? $_GET['title'] : NULL; ?>" placeholder="Solution Title" class="form-control">
									</div>
								</div>
							</div>
							<div class="col-md-4">
						...
						<div class="row">
							<div class="col-md-12 text-right float-right">
								...
								<a href="<?php echo base_url(); ?>caseStudies/manageOurSolutions" title="Clear" class="btn btn-default">Clear</a>
							</div>
						</div>
					</form>
					<!-- Filters end here -->
									...
									<table id="myTable" class="table table-bordered table-hover tbl_height">
										<thead>
											<tr>
												...
												<th class="tab-md-140">Solution Title</th>
											...
											<?php 	
												...
												foreach($resultData as $row)
												{
													...
													<tr>
														<td  class='text-center' style="width:90px;">
															<div class="dropdown" style="width:90px;">
																...
																<ul class="dropdown-menu dropdown-menu-right dropdown-menu-new">
																	<li>
																		<a href="<?php echo base_url(); ?>caseStudies/manageOurSolutions/edit/<?php echo $row['header_id'];?>" title="Edit">
																			<i class="fa fa-pencil"></i> Edit
																		</a>
																	</li>
																	
																	<li>
																		<a href="<?php echo base_url(); ?>caseStudies/manageOurSolutions/view/<?php echo $row['header_id'];?>" title="View">
																	...
																	<li>
																		<?php 
																			...
																			{
																				?>
																				<a class="unblock" href="<?php echo base_url(); ?>caseStudies/manageOurSolutions/status/<?php echo $row['header_id'];?>/N" title="Inactive">
																			...
																			{  ?>
																				<a class="block" href="<?php echo base_url(); ?>caseStudies/manageOurSolutions/status/<?php echo $row['header_id'];?>/Y" title="Active">
														...
														<td><?php echo ucfirst($row['casestudy_title']);?></td>
														...
														<td class="text-center">
															<?php 
																...
																{
																	$overview_url = "uploads/case_studies/solutions/".$row['header_id'].".png";
																	if(file_exists($overview_url))
																	{
																		?>
