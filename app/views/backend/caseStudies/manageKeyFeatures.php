				...
				if(isset($type) && $type == "add" || $type == "edit" || $type == "view")
				{
						...
						<div class="header-lines">
							...
							<div class="row mb-3">
								...
								<div class="col-md-6 text-right">
									...
									<a href="<?php echo base_url(); ?>caseStudies/manageKeyFeatures" class="btn btn-default btn-sm">Close</a>
								</div>
							</div>
							<!-- Buttons end here -->
									...
									<div class="row">
										<div class="col-md-6">
											...
											<div class="row">
												<div class="col-md-4">
													<div class="form-group text-right">
														<label class="col-form-label key_feature_image"><span class="text-danger">*</span> Image</label>
													</div>				
												</div>
												<div class="col-md-4">
													<div class="form-group">
														<input type="file" name="key_feature_image" id="key_feature_image" onchange='validateImage(this)' accept="image/*" class="form-control singleImage">
														<span class="exist_error text-warning"></span>
														<?php 
															if( ($type == "edit" || $type == "view") && isset($id))
															{
																$overview_url = "uploads/case_studies/key_features/".$id.".png";
					...
					<script>
						...
						function updateStatus(checkbox, id) 
						{
							...
							$.ajax({
								type: "GET",
								url: "<?php echo base_url().'caseStudies/ajaxAvailableKeyFeatures/status/';?>" + id + "/" + status,
								data: {}
							}).done(function(msg) 
							{
								toastr.success(msg);
						...
						function saveBtn(val) {
							...
							var key_feature_image 	= $("#key_feature_image").val();

							if (casestudies_id && (type !== 'add' || key_feature_image) ) 
							{

								$(".casestudies_id").removeClass('errorClass');
								$(".key_feature_image").removeClass('errorClass');
								...
								if (type === 'add' && !key_feature_image) {
									$(".key_feature_image").addClass('errorClass');
								} else {
									$(".key_feature_image").removeClass('errorClass');
								}
				...
				{ 
					...
					<div class="row">
						...
						<div class="col-md-6 float-right text-right">
							<a href="<?php echo base_url(); ?>caseStudies/manageKeyFeatures/add" class="btn btn-info btn-sm">
								Create key Feature
							</a>
					...
					<form action="" class="form-validate-jquery" method="get">
						<div class="row mt-3">
							...
							<div class="col-md-2">
								...
								<a href="<?php echo base_url(); ?>caseStudies/manageKeyFeatures" title="Clear" class="btn btn-default">Clear</a>
							</div>
						</div>
													...
													<tr>
														<td  class='text-center' style="width:90px;">
															<div class="dropdown" style="width:90px;">
																...
																<ul class="dropdown-menu dropdown-menu-right dropdown-menu-new">
																	<li>
																		<a href="<?php echo base_url(); ?>caseStudies/manageKeyFeatures/edit/<?php echo $row['header_id'];?>" title="Edit">
																			<i class="fa fa-pencil"></i> Edit
																		</a>
																	</li>
																	
																	<li>
																		<a href="<?php echo base_url(); ?>caseStudies/manageKeyFeatures/view/<?php echo $row['header_id'];?>" title="View">
																	...
																	<li>
																		<?php 
																			...
																			{
																				?>
																				<a class="unblock" href="<?php echo base_url(); ?>caseStudies/manageKeyFeatures/status/<?php echo $row['header_id'];?>/N" title="Inactive">
																			...
																			{  ?>
																				<a class="block" href="<?php echo base_url(); ?>caseStudies/manageKeyFeatures/status/<?php echo $row['header_id'];?>/Y" title="Active">
														...
														<td class="text-center">
															<?php 
																...
																{
																	$overview_url = "uploads/case_studies/key_features/".$row['header_id'].".png";
																	if(file_exists($overview_url))
																	{
																		?>
