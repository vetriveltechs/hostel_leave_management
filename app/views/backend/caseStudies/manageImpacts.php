				...
				if(isset($type) && $type == "add" || $type == "edit" || $type == "view")
				{
						...
						<div class="header-lines">
							...
							<div class="row mb-3">
								...
								<div class="col-md-6 text-right">
									...
									<a href="<?php echo base_url(); ?>caseStudies/manageImpacts" class="btn btn-default btn-sm">Close</a>
								</div>
							</div>
							<!-- Buttons end here -->
									...
									<div class="row">
										<div class="col-md-6">
											...
											<div class="row">
												<div class="col-md-4">
													<div class="form-group text-right">
														<label class="col-form-label impact_image"><span class="text-danger">*</span> Image</label>
													</div>				
												</div>
												<div class="col-md-4">
													<div class="form-group">
														<input type="file" name="impact_image" id="impact_image" onchange='validateImage(this)' accept="image/*" class="form-control singleImage">
														<span class="exist_error text-warning"></span>
														<?php 
															if( ($type == "edit" || $type == "view") && isset($id))
															{
																$overview_url = "uploads/case_studies/impacts/".$id.".png";
					...
					<script>
						...
						function updateStatus(checkbox, id) 
						{
							...
							$.ajax({
								type: "GET",
								url: "<?php echo base_url().'caseStudies/ajaxAvailableImpacts/status/';?>" + id + "/" + status,
								data: {}
							}).done(function(msg) 
							{
								toastr.success(msg);
						...
						function saveBtn(val) {
							...
							var impact_image 	= $("#impact_image").val();

							if (casestudies_id && (type !== 'add' || impact_image) ) 
							{

								$(".casestudies_id").removeClass('errorClass');
								$(".impact_image").removeClass('errorClass');
								...
								if (type === 'add' && !impact_image) {
									$(".impact_image").addClass('errorClass');
								} else {
									$(".impact_image").removeClass('errorClass');
								}
				...
				{ 
					...
					<div class="row">
						...
						<div class="col-md-6 float-right text-right">
							<a href="<?php echo base_url(); ?>caseStudies/manageImpacts/add" class="btn btn-info btn-sm">
					...
					<form action="" class="form-validate-jquery" method="get">
						<div class="row mt-3">
							...
							<div class="col-md-2">
								...
								<a href="<?php echo base_url(); ?>caseStudies/manageImpacts" title="Clear" class="btn btn-default">Clear</a>
							</div>
						</div>
													...
													<tr>
														<td  class='text-center' style="width:90px;">
															<div class="dropdown" style="width:90px;">
																...
																<ul class="dropdown-menu dropdown-menu-right dropdown-menu-new">
																	<li>
																		<a href="<?php echo base_url(); ?>caseStudies/manageImpacts/edit/<?php echo $row['header_id'];?>" title="Edit">
																			<i class="fa fa-pencil"></i> Edit
																		</a>
																	</li>
																	
																	<li>
																		<a href="<?php echo base_url(); ?>caseStudies/manageImpacts/view/<?php echo $row['header_id'];?>" title="View">
																	...
																	<li>
																		<?php 
																			...
																			{
																				?>
																				<a class="unblock" href="<?php echo base_url(); ?>caseStudies/manageImpacts/status/<?php echo $row['header_id'];?>/N" title="Inactive">
																			...
																			{  ?>
																				<a class="block" href="<?php echo base_url(); ?>caseStudies/manageImpacts/status/<?php echo $row['header_id'];?>/Y" title="Active">
														...
														<td class="text-center">
															<?php 
																...
																{
																	$overview_url = "uploads/case_studies/impacts/".$row['header_id'].".png";
																	if(file_exists($overview_url))
																	{
																		?>
