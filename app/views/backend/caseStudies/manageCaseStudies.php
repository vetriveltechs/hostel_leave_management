<?php
	...
	$getCaseStudyCategory 		= $this->common_model->lov('CASE-STUDIES');
						...
						<div class="header-lines">
							...
							<div class="row mb-3">
								...
								<div class="col-md-6 text-right">
									...
									?>
									<a href="<?php echo base_url(); ?>caseStudies/manageCaseStudies" class="btn btn-default btn-sm">Close</a>
									...
									<div class="row">
										<div class="col-md-6">
											...
											<div class="row">
												<div class="col-md-4">
													<div class="form-group text-right">
														<label class="col-form-label case_study_category"><span class="text-danger">*</span> Category</label>
													</div>
												</div>
												<div class="col-md-5">
													<div class="form-group">
														<select name="case_study_category" id="case_study_category" class="form-control <?php echo $searchDropdown;?>">
															<option value="">- Select -</option>
															<?php
																foreach($getCaseStudyCategory as $caseStudyCategory)
																{
																	$selected="";
																	if(isset($editData[0]['case_study_category']) && $editData[0]['case_study_category'] == $caseStudyCategory["list_code"] )
																	{
																		$selected="selected='selected'";
																	}
																	?>
																	<option value="<?php echo $caseStudyCategory["list_code"];?>" <?php echo $selected;?>><?php echo ucfirst($caseStudyCategory["list_value"]);?></option>
																	<?php
																}
															?>
														</select>
											...
											<div class="row">
												<div class="col-md-4">
													<div class="form-group text-right">
														<label class="col-form-label banner_images"><span class="text-danger">*</span> Banner Image</label>
													</div>
												</div>
												<div class="col-md-5">
													<div class="form-group">
														<input type="file" name="banner_image" id="banner_image" onchange='validateImage(this)' accept='.png, .gif, .jpg, .jpeg, .bmp' class="form-control singleImage">
															...
															<?php 
																...
																{
																	$url = "uploads/case_studies/banner/".$id.".png";
																	if(file_exists($url))
																	{
																		?><br>
											...
											<?php 
												...
												if($type!=='add'){
													if($editData[0]["best_casestudy"] == "Y")
													{
														$best_casestudyChecked = 'checked="checked"';
														
													}
													else if($editData[0]["best_casestudy"] == "N")
													{
														$best_casestudyChecked = '';
													}
												}
												else
												{
												...
												?>
													<div class="row align-items-center">
														<div class="col-md-4">
															<div class="form-group text-right">
																<label class="col-form-label best_casestudy">Best Casestudy</label>
															</div>
														</div>
														<div class="col-md-6 d-flex align-items-center">
															<div class="form-group">
																<input type="checkbox" name="best_casestudy" class="best_casestudy" <?php echo $disabledchk;?> id="" <?php echo $best_casestudyChecked;?> value="Y">
															</div>
														</div>
													</div>
										...
										<div class="col-md-6">
											<div class="row">
												<div class="col-md-4">
													<div class="form-group text-right">
														<label class="col-form-label case_study_image"><span class="text-danger">*</span> Casestudy Image</label>
													</div>
												</div>
												<div class="col-md-5">
													<div class="form-group">
														<input type="file" name="case_study_image" id="case_study_image" onchange='validateImage(this)' accept='.png, .gif, .jpg, .jpeg, .bmp' class="form-control singleImage">
															<span class="text-muted" ></span>
															<span class="exist_error text-warning"></span>
															...
															<?php 
																if( ($type == "edit" || $type == "view") && isset($id))
																{
																	$url = "uploads/case_studies/".$id.".png";
																	if(file_exists($url))
																	{
																		?><br>
																		<div class="form-group view-form row">
													...
													<div class="form-group">
														<input type="file" name="client_image" id="client_image" onchange='validateImage(this)' accept='.png, .gif, .jpg, .jpeg, .bmp' class="form-control singleImage">
															...
															<?php 
																if( ($type == "edit" || $type == "view") && isset($id))
																{
																	$url = "uploads/case_studies/client_images/".$id.".png";
																	if(file_exists($url))
																	{
																		?><br>
																		<div class="form-group view-form row">
									...
									$(document).ready(function () 
									{
										...
										function imageHandler() 
										{
											...
											input.onchange = async () => {
												...
												try {
													const response = await fetch('<?php echo base_url(); ?>caseStudies/upload_editor_image', {
														method: 'POST',
														body: formData
													});
										...
										function validateForm() {
											var title					= $("#title").val();
											var case_study_category 	= $("#case_study_category").val();
											var case_study_image 		= $("#case_study_image").val();
											...
											if (title.trim() !== "" && case_study_category !== "" && client_name.trim() !== "" && (type !== 'add' || banner_image) &&  (type !== 'add' || client_image) && (type !== 'add' || case_study_image) && sanitizedDescription !== "") 
											{
										...
										function saveBtn(val) {
											...
											if (title.trim() !== "" && case_study_category !== "" && client_name.trim() !== "" && (type !== 'add' || case_study_image) && (type !== 'add' || banner_image) && (type !== 'add' || client_image) &&  sanitizedDescription !== "") 
											{

												$(".title, .case_study_category,.banner_image,.client_image,.client_name,.case_study_image,.description").removeClass('errorClass');
												return true;
											} else {
												$(".form_submit_valid").prop('disabled', false);
												...
												if (case_study_category === "") $(".case_study_category").addClass('errorClass');
												if (type === 'add' && !banner_image) $(".banner_image").addClass('errorClass');
												if (type === 'add' && !client_image) $(".client_image").addClass('errorClass');
												if (type === 'add' && !case_study_image) $(".case_study_image").addClass('errorClass');
					...
					<div class="row">
						...
						<div class="col-md-6 float-right text-right">
							<?php
								...
								{
									?>
									<a href="<?php echo base_url(); ?>caseStudies/manageCaseStudies/add" class="btn btn-info btn-sm">
										Create Case Study
									</a>
									<?php
								}
					...
					<form action="" class="form-validate-jquery" method="get">
						<div class="row mt-3">
							...
							<div class="col-md-4">
								<div class="row">
									...
									<div class="form-group col-md-7">
										<select name="case_study_category" id="case_study_category" class="form-control searchDropdown">
											<option value="">- Select -</option>
											<?php 
												foreach($getCaseStudyCategory as $caseStudyCategory)
												{
													$selected="";
													if(isset($_GET["case_study_category"]) && $_GET["case_study_category"] == $caseStudyCategory['list_code'] )
													{
														$selected="selected='selected'";
													}
													?>
													<option value="<?php echo $caseStudyCategory['list_code'];?>" <?php echo $selected;?>><?php echo $caseStudyCategory['list_value'];?></option>
													<?php 
												} 
											?>
										</select>
						...
						<div class="row mb-3">
							...
							<div class="col-md-2">
								...
								<a href="<?php echo base_url(); ?>caseStudies/manageCaseStudies" title="Clear" class="btn btn-default">Clear</a>
							</div>
						</div>
					</form>
					<!-- Filters end here -->
								...
								<table id="myTable" class="table table-bordered table-hover tbl_height">
									<thead>
										<tr>
											...
											<th class="tab-md-140">Client Name</th>
										...
										<?php
											...
											foreach($resultData as $row)
											{
												...
												<td class="text-center">
																	...
																	{ 
																		...
																		<?php
																			if($physical_stock_adjustment['create_edit_only'] == 1 || $this->user_id == 1)
																			{
																				?>
																					<li>
																						<a title="Edit" href="<?php echo base_url(); ?>caseStudies/manageCaseStudies/edit/<?php echo $row['casestudies_id'];?>/">
																		...
																		<?php
																			if($physical_stock_adjustment['read_only'] == 1 || $this->user_id == 1)
																			{
																				...
																				?>
																				<li>
																					<a title="View" href="<?php echo base_url(); ?>caseStudies/manageCaseStudies/view/<?php echo $row['casestudies_id'];?>/">
																			...
																			if($physical_stock_adjustment['create_edit_only'] == 1 || $this->user_id == 1)
																			{
																				...
																				<li>
																					<?php 
																						...
																						{
																							?>
																							<a class="unblock" href="<?php echo base_url(); ?>caseStudies/manageCaseStudies/status/<?php echo $row['casestudies_id'];?>/N" title="Inactive">
																						...
																						{  ?>
																							<a class="block" href="<?php echo base_url(); ?>caseStudies/manageCaseStudies/status/<?php echo $row['casestudies_id'];?>/Y" title="Active">
													...
													<td class="text-center">
														<?php 
															if(isset($row['casestudies_id']))
															{
																$url = "uploads/case_studies/".$row['casestudies_id'].".png";
																if(file_exists($url))
																{
																	?>
