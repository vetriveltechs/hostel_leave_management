<?php
	$recovery_adjustment = accessMenu(recovery_adjustment);
?>
			...
			<?php
				if(isset($type) && $type == "add")
				{
					...
					<legend class="text-uppercase font-size-sm font-weight-bold">
						<?php echo $type; ?> Recovery Adjustment
					</legend>
					<form action="<?php echo base_url();?>employee/ManageRecovery/add" class="form-validate-jquery" --id="formValidation" enctype="multipart/form-data" method="post">
						<div class="row">
							<?php 
							...
							<?php 
								...
								where category_type=2 and category_id !=5 order by category_name asc";
						...
						<!-- Table start here-->
						<div class="row employee_recovery_table" style="display:none;">
							<div class="col-md-12">
						...
						<div class="d-flexad text-right mt-4">
							<a href="<?php echo base_url(); ?>employee/ManageRecovery" class="btn btn-light">Cancel  </a>
				...
				else if(isset($type) && $type == "edit")
				{
					...
					<form action="" class="form-validate-jquery" --id="formValidation" enctype="multipart/form-data" method="post">
						...
						<div class="d-flexad" style="text-align:right;">
							<a href="<?php echo base_url(); ?>employee/ManageRecovery/grid_view" class="btn btn-light">Cancel  </a>
							<?php 
								if($type == "edit")
								{
									?>
				...
				{ 
					...
					<div class="row mb-2">
						...
						<div class="col-md-6 float-right text-right">
							<?php
								if((isset($recovery_adjustment['create_edit_only']) && $recovery_adjustment['create_edit_only'] == 1) || $this->user_id == 1)
								{
									?>
									<a href="<?php echo base_url(); ?>employee/ManageRecovery/add" class="btn btn-info btn-sm">
										...
										<div class="row">
											...
											<div class="col-md-3">	
												<?php 
													...
													join emp_recovery on 
														emp_recovery.financial_year_id = org_financial_years.financial_year_id
													
															where org_financial_years.financial_status = 1
													
													group by emp_recovery.financial_year_id
													";
											...
											<div class="col-md-2">	
												<select name="element_id" class="form-control searchDropdown">
													<option value="">- Select Element -</option>
													<?php 
														$elementQry = "select category_id,category_type,category_name from hr_payslip_categories 

														join emp_recovery on 
															emp_recovery.element_id = hr_payslip_categories.category_id
														where 
															hr_payslip_categories.category_type=2 
																group by emp_recovery.element_id
													...
													if((isset($recovery_adjustment['create_edit_only']) && $recovery_adjustment['create_edit_only'] == 1) || $this->user_id == 1)
													{
														...
														<div class="dropdown controls-actions show">
															...
															<ul class="dropdown-menu dropdown-menu-right">
																<li>
																	<a title="Edit" href="<?php echo base_url(); ?>employee/ManageRecovery/edit/<?php echo $row['recovery_id'];?>">
