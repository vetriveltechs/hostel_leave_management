	...
	<div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
		<div class="d-flex">
			<div class="breadcrumb">
				...
				<a href="<?php echo base_url();?>employee/ManageDepartment" class="breadcrumb-item"><?php echo $page_title;?></a>
			</div>
		</div>
		<?php
			...
			{ 
				...
				<div class="d-flexad" style="text-align:right;">
					...
					<a href="<?php echo base_url(); ?>employee/ManageDepartment/add" class="btn btn-info">
						Add Department
					</a>
				</div>
				<?php 
					...
					if(isset($type) && $type == "add" || $type == "edit")
					{
						...
						<legend class="text-uppercase font-size-sm font-weight-bold">
							...
							<form action="" class="form-validate-jquery" --id="formValidation" enctype="multipart/form-data" method="post">
										...
										<fieldset class="mb-3">
											<div class="row">
												<div class="form-group col-md-3">
													...
													<input type="text" name="department_name" required <?php //echo $this->validation; ?> class="form-control" value="<?php echo isset($edit_data[0]['department_name']) ? $edit_data[0]['department_name'] :"";?>" placeholder="">
												</div>
											</div>
								...
								<div class="d-flexad" style="text-align:right;">
									<a href="<?php echo base_url(); ?>employee/ManageDepartment" class="btn btn-light">Cancel  </a>
									<?php 
										if($type == "edit")
										{
											?>
					...
					{ 
						...
						<div class="row mb-2">
							...
							<div class="col-md-6 float-right text-right">
								...
								<a href="<?php echo base_url(); ?>employee/ManageDepartment/add" class="btn btn-info btn-sm">
									Add Department
								</a>
							</div>
						</div>
								...
								<div class="col-md-8">
									<div class="row">
										<div class="col-md-5">	
											...
											<p class="search-note">Note :  Department Name</p>
										</div>	
									...
									<?php 	
										...
										foreach($resultData as $row)
										{
											...
											<tr>
												<td style="width:5% !important;" class="text-center">
													<div class="dropdown" style="display: inline-block;padding-right: 10px!important;">
														...
														<ul class="dropdown-menu dropdown-menu-right">
															<li>
																<a title="Edit" href="<?php echo base_url(); ?>employee/ManageDepartment/edit/<?php echo $row['department_id'];?>">
												...
												<td style="width:10%;"><?php echo ucfirst($row['department_name']);?></td>
