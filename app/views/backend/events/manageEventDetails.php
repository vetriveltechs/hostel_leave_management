					...
					<form action="" --class="form-validate-jquery" enctype="multipart/form-data" method="post">				
						<div class="header-lines">
									...
									<div class="row">
										<div class="col-md-6">
											<div class="row">
												<div class="col-md-4">
													<div class="form-group text-right">
														<label class="col-form-label event_id"><span class="text-danger">*</span> Event Name</label>
													</div>				
												</div>
												<div class="col-md-4">
													<div class="form-group">
														<div class="input-wrapper">
															<input type="text" name="event_title" autocomplete="off" id="event_title" value="<?php echo isset($editData[0]['event_title']) ? $editData[0]['event_title'] : NULL; ?>" placeholder="Event Title" class="form-control">
															<input type="hidden" name="event_id" autocomplete="off" id="event_id" value="<?php echo isset($editData[0]['event_id']) ? $editData[0]['event_id'] : NULL; ?>" >
															<div id="EventTitleList"></div><!-- Clear icon start -->
																<?php 
																	if(isset($editData[0]["event_id"]) && $editData[0]["event_id"] !== '')
																	{
											...
											<div class="row">
												...
												<div class="col-md-4">
													<div class="form-group">
														<input type="text" name="title" id="title" placeholder="Title" class="form-control" value="<?php echo isset($editData[0]['title']) ? $editData[0]['title'] : NULL;?>"></input>
													</div>				
												</div>
											</div>
											<div class="row">
											...
											<div class="row">
												<div class="col-md-4">
													<div class="form-group text-right">
														<label class="col-form-label banner_image"><span class="text-danger">*</span> Event Image </label>
													</div>				
												</div>
												<div class="col-md-4">
													<div class="form-group">
														...
														<?php 
															...
															{
																$event_url = "uploads/events/details/banner/".$id.".png";
								...
								<script>
									$(document).ready(function() {
										...
										function validateForm() {
											...
											if (event_id !== "" && title.trim() !== "" && description.trim() !== "" && (type !== 'add' || banner_image)) 
											{
							...
							<div class="col-md-12 mt-3 pr-0 text-right">
								...
								?>
								<a href="<?php echo base_url(); ?>events/manageEventDetails" class="btn btn-default btn-sm">Close</a>
							</div>
					...
					<div class="row">
						...
						<div class="col-md-6 float-right text-right">
							<?php
								...
								{
									?>
									<a href="<?php echo base_url(); ?>events/manageEventDetails/add" class="btn btn-info btn-sm">
										Create Event Detail
									</a>
									<?php 
								} 
					...
					<form action="" class="form-validate-jquery" method="get">
						<div class="row mt-3">
							...
							<div class="col-md-4">
								<div class="row">
									...
									<div class="form-group col-md-7">
										<input type="text" name="keywords" id="keywords" class="form-control" value="<?php echo !empty($_GET['keywords']) ? $_GET['keywords'] : ""; ?>" placeholder="Title">
									</div>
								</div>
							</div>
						...
						<div class="row">
							...
							<div class="col-md-2">
								...
								<a href="<?php echo base_url(); ?>events/manageEventDetails" title="Clear" class="btn btn-default">Clear</a>
							</div>
						</div>
					</form>
					<!-- Filters end here -->
								...
								<table id="myTable" class="table table-bordered table-hover tbl_height">
									<thead>
										<tr>
											...
											<th class="tab-md-140">Event Name</th>
												...
												<tr>
																	...
																	{ 
																		...
																		<?php
																			if($physical_stock_adjustment['create_edit_only'] == 1 || $this->user_id == 1)
																			{
																				?>
																					<li>
																						<a title="Edit" href="<?php echo base_url(); ?>events/manageEventDetails/edit/<?php echo $row['event_id'];?>/">
																		...
																		<?php
																			if($physical_stock_adjustment['read_only'] == 1 || $this->user_id == 1)
																			{
																				...
																				?>
																				<li>
																					<a title="View" href="<?php echo base_url(); ?>events/manageEventDetails/view/<?php echo $row['event_detail_id'];?>/">
																			...
																			if($physical_stock_adjustment['create_edit_only'] == 1 || $this->user_id == 1)
																			{
																				...
																				<li>
																					<?php 
																						...
																						{
																							?>
																							<a class="unblock" href="<?php echo base_url(); ?>events/manageEventDetails/status/<?php echo $row['event_detail_id'];?>/N" title="Inactive">
																						...
																						{  ?>
																							<a class="block" href="<?php echo base_url(); ?>events/manageEventDetails/status/<?php echo $row['event_detail_id'];?>/Y" title="Active">
													...
													<td class="text-center">
														<?php 
															...
															{
																$event_detail_url = "uploads/events/details/banner/".$row['event_detail_id'].".png";
																if(file_exists($event_detail_url))
																{
																	?>
																	<img src="<?php echo base_url().$event_detail_url;?>" style="width:50px !important; height:40px !important;" alt="...">
																	<?php 
																}else{
																	?>
