				...
				if(isset($type) && $type == "add" || $type == "edit" || $type == "view")
				{
						...
						<div class="header-lines">
							...
							<div class="row mb-3">
								...
								<div class="col-md-6 text-right">
									...
									<a href="<?php echo base_url(); ?>events/manageAbouts" class="btn btn-default btn-sm">Close</a>
								</div>
							</div>
							<!-- Buttons end here -->
									...
									<div class="row">
										<div class="col-md-6">
											<div class="row">
												<div class="col-md-4">
													<div class="form-group text-right">
														<label class="col-form-label event_id"><span class="text-danger">*</span> Event Title</label>
													</div>				
												</div>
												<div class="col-md-5">
													<div class="form-group">
														<div class="input-wrapper">
															<input type="text" name="event_title" autocomplete="off" id="event_title" value="<?php echo isset($headerData[0]['event_title']) ? $headerData[0]['event_title'] : NULL; ?>" placeholder="Event Title" class="form-control">
											...
											<div class="row">
												<div class="col-md-4">
													<div class="form-group text-right">
														<label class="col-form-label about_title"><span class="text-danger">*</span> Title</label>
													</div>				
												</div>
												<div class="col-md-4">
													<div class="form-group">
														<input type="text" name="about_title" id="about_title" placeholder="Title" class="form-control" value="<?php echo isset($headerData[0]['about_title']) ? $headerData[0]['about_title'] : NULL;?>"></input>
													</div>				
												</div>
											</div>
											<div class="row">
												...
												<div class="col-md-4">
													<div class="form-group">
														<textarea name="description" id="description" class="form-control"><?php echo isset($headerData[0]['description']) ? $headerData[0]['description'] : NULL;?></textarea>
													</div>				
												</div>
											</div>
										</div>
					...
					<script>
						...
						function updateStatus(checkbox, id) 
						{
							...
							$.ajax({
								type: "GET",
								url: "<?php echo base_url().'events/ajaxAvailableAbouts/status/';?>" + id + "/" + status,
								data: {}
							}).done(function(msg) 
							{
								toastr.success(msg);
						...
						function saveBtn(val) {
							...
							if (event_id && about_title && description) 
							{

								$(".event_id").removeClass('errorClass');
								$(".about_title").removeClass('errorClass');
							...
							else 
							{
								...
								if (!about_title) $(".about_title").addClass('errorClass');
								else $(".about_title").removeClass('errorClass');
								...
								success: function(d)
								{
									...
									if(flag == 0)
									{
										...
										cols += "<td class='tab-md-150'>" 
											+"<input type='text' class='form-control' name='line_title[]' id='line_title"+ counter +"' value=''>"
										+"</td>";
				...
				{ 
					...
					<div class="row">
						...
						<div class="col-md-6 float-right text-right">
							<a href="<?php echo base_url(); ?>events/manageAbouts/add" class="btn btn-info btn-sm">
								Create About Event
							</a>
						</div>
					</div>
					...
					<form action="" class="form-validate-jquery" method="get">
						<div class="row mt-3">
							<div class="col-md-4">
								<div class="row">
									<label class="col-form-label col-md-5">Event Title</label>
							...
							<div class="col-md-4">
								<div class="row">
									<label class="col-form-label col-md-5">Keyword</label>
									<div class="form-group col-md-7">
										<input type="text" name="keywords" autocomplete="off" id="keywords" value="<?php echo isset($_GET['keywords']) ? $_GET['keywords'] : NULL; ?>" placeholder="Title / Description" class="form-control">
									</div>
								</div>
							</div>
							<div class="col-md-4">
						...
						<div class="row">
							<div class="col-md-12 text-right float-right">
								...
								<a href="<?php echo base_url(); ?>events/manageAbouts" title="Clear" class="btn btn-default">Clear</a>
							</div>
						</div>
					</form>
					<!-- Filters end here -->
									...
									<table id="myTable" class="table table-bordered table-hover tbl_height">
										<thead>
											<tr>
												...
												<th class="tab-md-140">Even Title</th>
												<th class="tab-md-140">Title</th>
												<th class="tab-md-140">Description</th>
											...
											<?php 	
												...
												foreach($resultData as $row)
												{
													...
													<tr>
														<td  class='text-center' style="width:90px;">
															<div class="dropdown" style="width:90px;">
																...
																<ul class="dropdown-menu dropdown-menu-right dropdown-menu-new">
																	<li>
																		<a href="<?php echo base_url(); ?>events/manageAbouts/edit/<?php echo $row['header_id'];?>">
																			<i class="fa fa-pencil"></i> Edit
																		</a>
																	</li>
																	
																	<li>
																		<a href="<?php echo base_url(); ?>events/manageAbouts/view/<?php echo $row['header_id'];?>">
																	...
																	<li>
																		<?php 
																			...
																			{
																				?>
																				<a class="unblock" href="<?php echo base_url(); ?>events/manageAbouts/status/<?php echo $row['header_id'];?>/N" title="Inactive">
																			...
																			{  ?>
																				<a class="block" href="<?php echo base_url(); ?>events/manageAbouts/status/<?php echo $row['header_id'];?>/Y" title="Active">
														...
														<td>
															<?php echo ucfirst($row['about_title']);?>
														</td>
														<td>
