				...
				if(isset($type) && $type == "add" || $type == "edit" || $type == "view")
				{
						...
						<div class="header-lines">
							...
							<div class="row mb-3">
								...
								<div class="col-md-6 text-right">
									...
									<a href="<?php echo base_url(); ?>events/manageEventGallery" class="btn btn-default btn-sm">Close</a>
								</div>
							</div>
							<!-- Buttons end here -->
														...
														if( count($lineData) > 0)
														{
															...
															foreach($lineData as $lineItems)
															{
																...
																<tr class="remove_tr tabRow<?php echo $counter;?>">
																	...
																	?>
																	<td class="tab-md-85">
																		<input type="text" class="form-control" name="order_sequence[]" id="order_sequence<?php echo $counter;?>" value="<?php echo isset($lineItems["order_sequence"]) ? $lineItems["order_sequence"] : "";?>" oninput="validateNumber(this)"></input>
																	</td>
																	
																	<td class="tab-md-85">
																		<input type="file" name="gallery_image[]" id="gallery_image" class="form-control singleImage" onchange='validateImage(this)' accept='.png, .gif, .jpg, .jpeg, .bmp'>
																		<?php 
																			if( ($type == "edit" || $type == "view") && isset($lineItems["line_id"]))
																			{
																				$url = "uploads/events/gallery/".$lineItems["line_id"].".png";
																				if(file_exists($url))
																				{
																					?>
																					<?php /*
					...
					<script>
						...
						function updateStatus(checkbox, id) 
						{
							...
							$.ajax({
								type: "GET",
								url: "<?php echo base_url().'events/ajaxAvailableGallery/status/';?>" + id + "/" + status,
								data: {}
							}).done(function(msg) 
							{
								toastr.success(msg);
						...
						function saveBtn(val) {
							...
							if (event_id) 
							{
								...
								$("table.line_items").find('tr').each(function () {
									...
									var gallery_image    	= row.find('input[name^="gallery_image[]"]').val();

									if (order_sequence === "" || (gallery_image === "" && type !== 'edit')) 
									{
										lineIncomplete = true;
										return false;
									}
							...
							$.ajax({
								...
								success: function(d)
								{
									...
									if(flag == 0)
									{
										...
										cols += "<td class='tab-md-150'>" 
											+"<input type='file' class='form-control' name='gallery_image[]' id='gallery_image"+ counter +"' value='' onchange='validateImage(this)' accept='.png, .gif, .jpg, .jpeg, .bmp'></input>"
										+"</td>";
				...
				{ 
					...
					<div class="row">
						...
						<div class="col-md-6 float-right text-right">
							<a href="<?php echo base_url(); ?>events/manageEventGallery/add" class="btn btn-info btn-sm">
					...
					<form action="" class="form-validate-jquery" method="get">
						<div class="row mt-3">
							...
							<div class="col-md-4">
								<div class="row">
									...
									<div class="form-group col-md-7">
										<input type="text" name="keywords" autocomplete="off" id="keywords" value="<?php echo isset($_GET['keywords']) ? $_GET['keywords'] : NULL; ?>" placeholder="Title" class="form-control">
									</div>
								</div>
							</div>
							<div class="col-md-4">
						...
						<div class="row">
							<div class="col-md-12 text-right float-right">
								...
								<a href="<?php echo base_url(); ?>events/manageEventGallery" title="Clear" class="btn btn-default">Clear</a>
							</div>
						</div>
					</form>
					<!-- Filters end here -->
									...
									<table id="myTable" class="table table-bordered table-hover tbl_height">
										<thead>
											<tr>
												...
												<th class="tab-md-140">Even Name</th>
														...
														<td  class='text-center' style="width:90px;">
															<div class="dropdown" style="width:90px;">
																...
																<ul class="dropdown-menu dropdown-menu-right dropdown-menu-new">
																	<li>
																		<a href="<?php echo base_url(); ?>events/manageEventGallery/edit/<?php echo $row['header_id'];?>">
																			<i class="fa fa-pencil"></i> Edit
																		</a>
																	</li>
																	
																	<li>
																		<a href="<?php echo base_url(); ?>events/manageEventGallery/view/<?php echo $row['header_id'];?>">
																	...
																	<li>
																		<?php 
																			...
																			{
																				?>
																				<a class="unblock" href="<?php echo base_url(); ?>events/manageEventGallery/status/<?php echo $row['header_id'];?>/N" title="Inactive">
																			...
																			{  ?>
																				<a class="block" href="<?php echo base_url(); ?>events/manageEventGallery/status/<?php echo $row['header_id'];?>/Y" title="Active">
